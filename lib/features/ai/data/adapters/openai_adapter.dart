...
class OpenAIAdapter implements AIProviderAdapter {
  ...
  OpenAIAdapter(this._dio, this._registry);
  ...
  Future<UnifiedResponse> generate(UnifiedRequest request) async {
    ...
    try {
      final model = request.modelId ?? 'gpt-4o';
      ...
      return UnifiedResponse(
        ...
        latencyMs: 0, // Calculated by caller or interceptor
  ...
  Stream<UnifiedResponse> generateStream(UnifiedRequest request) {
    throw UnimplementedError('Streaming not supported by openai');
  }
}
